    ...
    */
    ...
    <body>
        ...
        <form class='' action='/wp-content/themes/Culture_FX/bd_insert.php' method='post'>
            ...
            <p class='center_text'>Exclusively For The Group: <span id='group'>Registration</span></p>
            <p class='center_text'>Your organizer: <span id='organizer'>Admin</span></p>
            ...
            <input class='m_width' type='email' name='cul_email' value='' pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
          ...
          <div class='c-level-input'>
              <input type='checkbox' name='c-level' value='Yes' id='yes_c_level' checked><label for='yes_c_level'>Yes</label><br>
